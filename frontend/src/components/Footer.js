        ...
        <footer className="App-footer">
            ...
            <div className="footer-content">
                <ul className="useful-links">
                    ...
                    <li>
                        <a href="https://code4.ro/ro/codul-de-conduita/">Codul de Conduită</a>
                    </li>
                    <li>
                        <a href="https://code4.ro/ro/">Code for Romania</a>
                    </li>
                    <li>
                ...
                <div className="code4-branding">
                    <a href="https://code4.ro/ro/">
                        <img
                            src={code4romania_gray}
                            alt="Code for Romania gray logo"
                        ></img>
                    </a>
