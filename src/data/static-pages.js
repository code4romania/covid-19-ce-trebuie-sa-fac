export default [
  {
    ...
    content: [
      ...
      <p style="background-color: #ffd738; padding: 10px;"> <a target="_blank" href="https://stirioficiale.ro/storage/0611_Model Declaratie proprie Raspundere_noapte.pdf"> Descarcă de aici </a> modelul de declarație pe proprie răspundere </p>
      <p style="background-color: #ffd738; padding: 10px;"> <a target="_blank" href="https://stirioficiale.ro/storage/0611_Adeverinta pentru angajatori_noapte_.pdf"> Descarcă de aici </a>  modelul de adeverință de angajator </p>
